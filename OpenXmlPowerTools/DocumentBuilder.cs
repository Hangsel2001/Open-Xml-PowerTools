    ...
    <w:docPart>
      ...
      <w:docPartBody>
        ...
        private static XAttribute[] NamespaceAttributes =
        {
            ...
            new XAttribute(XNamespace.Xmlns + "w16", W16.w16),
            new XAttribute(XNamespace.Xmlns + "w16se", W16SE.w16se),
            new XAttribute(XNamespace.Xmlns + "w16cid", W16CID.w16cid),
            new XAttribute(XNamespace.Xmlns + "w16cex", W16CEX.w16cex),
            new XAttribute(XNamespace.Xmlns + "aink", "http://schemas.microsoft.com/office/drawing/2016/ink"),
            new XAttribute(XNamespace.Xmlns + "am3d", "http://schemas.microsoft.com/office/drawing/2017/model3d"),
            new XAttribute(XNamespace.Xmlns + "cx", "http://schemas.microsoft.com/office/drawing/2014/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx1", "http://schemas.microsoft.com/office/drawing/2015/9/8/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx2", "http://schemas.microsoft.com/office/drawing/2015/10/21/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx3", "http://schemas.microsoft.com/office/drawing/2016/5/9/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx4", "http://schemas.microsoft.com/office/drawing/2016/5/10/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx5", "http://schemas.microsoft.com/office/drawing/2016/5/11/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx6", "http://schemas.microsoft.com/office/drawing/2016/5/12/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx7", "http://schemas.microsoft.com/office/drawing/2016/5/13/chartex"),
            new XAttribute(XNamespace.Xmlns + "cx8", "http://schemas.microsoft.com/office/drawing/2016/5/14/chartex"),
            new XAttribute(MC.Ignorable, "w14 wp14 w15 w16se w16cid w16 w16cex"),
        };
    }
